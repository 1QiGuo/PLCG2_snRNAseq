...
spot_annotation[, 2][which(spot_annotation[, 2] == "")] <-
  "non_AT8_level4"
spot_annotation_new <-
  spot_annotation[-which(spot_annotation[, 2] == "non_AT8_level4"),]
table(spot_annotation_new$AT8)
dim(spot_annotation_new)
...
table(sample6.combined_withnonoise_nolevel4$pathology)
...
sample6.combined_withnonoise_nolevel4_nocontrol_scale<-ScaleData(sample6.combined_withnonoise_nolevel4_nocontrol)
sample6.combined_withnonoise_nolevel4_scale<-ScaleData(sample6.combined_withnonoise_nolevel4)
...
#VlnPlot(sample6.combined_withnonoise_nolevel4,assay = "Spatial",slot="data",features = c("PLCG2"))
 ...
 VlnPlot(sample6.combined_withnonoise_nolevel4_scale,assay = "SCT",slot = 'data',features = c("PLCG2"),pt.size = 0,add.noise = F)
...
pdf(
  "violin_PLCG2_nonoise_nolevel4_nocontrol_at8.pdf",
  # File name
  width = 10,
  height = 9,
...
write.csv(sta_df,"/fs/ess/PCON0022/guoqi/AD/Tae_yeon/Results/Statisticalsummary_pairwisecompare_at8_PLCG2_nocontrol.csv")
...
plcg2_stat_all_fetch<-statistical_funtion(violin_data,"PLCG2_allcomparison")
write.csv(plcg2_stat_all_fetch, "/fs/ess/PCON0022/guoqi/AD/Tae_yeon/Results/Statisticalsummary_allfour_at8_PLCG2_nocontrol.csv")
